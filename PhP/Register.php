...
<body class="d-flex align-items-center justify-content-center vh-99">
    <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="../Database/conn.php">
                            ...
                            <div class="mb-3">
                                <label for="country" class="form-label">Geboorteplaats:</label>
    ...
    <img class="Image" src="../Assets/Images/proxy-image.jpeg" alt="Night sky" >
